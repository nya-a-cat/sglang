...
// ========================= I-quant MoE MMQ launchers =========================
// The format-specific tile loaders and dot products are adapted from vLLM
// PR #36226 and llama.cpp. These launchers wire them into SGLang's existing
// moe_q scheduler while preserving its token sorting and output layout.

// ========================= IQ2_XS =========================

#if defined(USE_ROCM)
#define MOE_X_IQ2_XS 8
#define MOE_Y_IQ2_XS 128
#define MOE_NWARPS_IQ2_XS 8
#else
#define MOE_X_IQ2_XS 4
#define MOE_Y_IQ2_XS 32
#define MOE_NWARPS_IQ2_XS 4
#endif

template <typename scalar_t, bool need_check>
static __global__ void
#if defined(USE_ROCM)
__launch_bounds__(WARP_SIZE_GGUF* MOE_NWARPS_IQ2_XS, 2)
#endif
    moe_iq2_xs(
        const void* __restrict__ vx,
        const void* __restrict__ vy,
  ...
  const int nwarps = MOE_NWARPS_IQ2_XS;
...
#define MOE_NWARPS_IQ3_XXS 8
#else
#define MOE_X_IQ3_XXS 4
#define MOE_Y_IQ3_XXS 32
#define MOE_NWARPS_IQ3_XXS 4
#endif

template <typename scalar_t, bool need_check>
static __global__ void
#if defined(USE_ROCM)
__launch_bounds__(WARP_SIZE_GGUF* MOE_NWARPS_IQ3_XXS, 2)
#endif
    moe_iq3_xxs(
        const void* __restrict__ vx,
        const void* __restrict__ vy,
  ...
  const int nwarps = MOE_NWARPS_IQ3_XXS;
...
#if defined(USE_ROCM)
#define MOE_X_IQ3_S 8
#define MOE_Y_IQ3_S 128
#define MOE_NWARPS_IQ3_S 8
#else
#define MOE_X_IQ3_S 4
#define MOE_Y_IQ3_S 32
#define MOE_NWARPS_IQ3_S 4
#endif

template <typename scalar_t, bool need_check>
static __global__ void
#if defined(USE_ROCM)
__launch_bounds__(WARP_SIZE_GGUF* MOE_NWARPS_IQ3_S, 2)
#endif
    moe_iq3_s(
        const void* __restrict__ vx,
        const void* __restrict__ vy,
  ...
  const int nwarps = MOE_NWARPS_IQ3_S;
